 ...
 * Package Name:store.zabbix.wheather.run
 * Date:2017年3月1日下午2:17:45
 * Copyright (c) 2017, yhc8023tm@foxmail.com All Rights Reserved.
 *
*/

package store.zabbix.wheather.run;

import java.util.List;
import java.util.HashMap;
import java.util.Map;

import store.zabbix.wheather.model.Friend;
import store.zabbix.wheather.model.FriendList;
import store.zabbix.wheather.util.HttpUtil;
import store.zabbix.wheather.util.MailUtil;
import store.zabbix.wheather.util.PropertiesUtil;
